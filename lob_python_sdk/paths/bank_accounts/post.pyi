...
from lob_python_sdk.model.bank_account_base import BankAccountBase as BankAccountBaseSchema
...
from lob_python_sdk.pydantic.bank_account_base import BankAccountBase as BankAccountBasePydantic

# body param
SchemaForRequestBodyApplicationJson = BankAccountBaseSchema
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BankAccountBaseSchema
SchemaForRequestBodyMultipartFormData = BankAccountBaseSchema


request_body_bank_account_base = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_bank_account_mapped_args(
        self,
        routing_number: str,
        account_number: str,
        account_type: str,
        ...
        check_template: typing.Optional[str] = None,
        fractional_routing_number: typing.Optional[str] = None,
        ...
        if signatory is not None:
            _body["signatory"] = signatory
        if check_template is not None:
            _body["check_template"] = check_template
        if fractional_routing_number is not None:
            _body["fractional_routing_number"] = fractional_routing_number
        if city is not None:
            _body["city"] = city
    ...
    async def _acreate_new_bank_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/bank_accounts',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_bank_account_base.serialize(body, content_type)
    ...
    def _create_new_bank_account_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewBankAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_bank_account(
        self,
        routing_number: str,
        account_number: str,
        account_type: str,
        ...
        **kwargs,
        ...
        args = self._create_new_bank_account_mapped_args(
        ...
        return await self._acreate_new_bank_account_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_bank_account(
        ...
        return self._create_new_bank_account_oapg(
            body=args.body,
        )

class CreateNewBankAccount(BaseApi):
    ...
    async def acreate_new_bank_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_bank_account(
            routing_number=routing_number,
            account_number=account_number,
            account_type=account_type,
            signatory=signatory,
    ...
    def create_new_bank_account(
        ...
        raw_response = self.raw.create_new_bank_account(
            routing_number=routing_number,
            account_number=account_number,
            account_type=account_type,
            signatory=signatory,
