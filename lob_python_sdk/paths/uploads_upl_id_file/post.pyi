...
from lob_python_sdk.model.upload_file_request import UploadFileRequest as UploadFileRequestSchema
from lob_python_sdk.model.upload_create_response import UploadCreateResponse as UploadCreateResponseSchema
from lob_python_sdk.model.upload_file import UploadFile as UploadFileSchema
...
from lob_python_sdk.type.upload_file_request import UploadFileRequest
from lob_python_sdk.type.upl_id import UplId
from lob_python_sdk.type.upload_file import UploadFile

from ...api_client import Dictionary
from lob_python_sdk.pydantic.upload_file_request import UploadFileRequest as UploadFileRequestPydantic
from lob_python_sdk.pydantic.upload_create_response import UploadCreateResponse as UploadCreateResponsePydantic
from lob_python_sdk.pydantic.upload_file import UploadFile as UploadFilePydantic
...
# body param
SchemaForRequestBodyMultipartFormData = UploadFileRequestSchema


request_body_upload_file_request = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = UploadFileSchema
    ...
    async def _afile_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/uploads/{upl_id}/file',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_upload_file_request.serialize(body, content_type)
...
class File(BaseApi):
    ...
    async def afile(
        ...
        **kwargs,
        ...
        if validate:
            return UploadFilePydantic(**raw_response.body)
        return api_client.construct_model_instance(UploadFilePydantic, raw_response.body)
