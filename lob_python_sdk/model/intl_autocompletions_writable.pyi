...
class IntlAutocompletionsWritable(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address_prefix", "country", "city", "state", "zip_code", "geo_ip_sort", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address_prefix", "country", "city", "state", "zip_code", "geo_ip_sort", ], str]):
