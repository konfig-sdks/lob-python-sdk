...
from lob_python_sdk.pydantic.inline_address_us_chk import InlineAddressUsChk

class CheckInputTo(BaseModel):
    ...
    to: typing.Optional[typing.Union[AdrId, InlineAddressUsChk]] = Field(None, alias='to')
    class Config:
