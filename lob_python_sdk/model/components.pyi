...
class Components(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["zip_code", "zip_code_plus_4", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["zip_code", "zip_code_plus_4", ], str]):
