...
RequiredCreativeBase = TypedDict("RequiredCreativeBase", {
    })

OptionalCreativeBase = TypedDict("OptionalCreativeBase", {
...
class CreativeBase(RequiredCreativeBase, OptionalCreativeBase):
    pass
