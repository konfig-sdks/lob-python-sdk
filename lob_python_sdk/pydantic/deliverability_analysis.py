...
from lob_python_sdk.pydantic.dpv_footnote import DpvFootnote
...
class DeliverabilityAnalysis(BaseModel):
    ...
    dpv_confirmation: Literal["Y", "S", "D", "N", ""] = Field(alias='dpv_confirmation')
    ...
    dpv_cmra: Literal["Y", "N", ""] = Field(alias='dpv_cmra')
    ...
    dpv_vacant: Literal["Y", "N", ""] = Field(alias='dpv_vacant')
    ...
    dpv_active: Literal["Y", "N", ""] = Field(alias='dpv_active')
    ...
    dpv_inactive_reason: Literal["01", "02", "03", "04", "05", "06", ""] = Field(alias='dpv_inactive_reason')
    ...
    dpv_throwback: Literal["Y", "N", ""] = Field(alias='dpv_throwback')
    ...
    dpv_non_delivery_day_flag: Literal["Y", "N", ""] = Field(alias='dpv_non_delivery_day_flag')
    ...
    dpv_non_delivery_day_values: str = Field(alias='dpv_non_delivery_day_values')
    ...
    dpv_no_secure_location: Literal["Y", "N", ""] = Field(alias='dpv_no_secure_location')
    ...
    dpv_door_not_accessible: Literal["Y", "N", ""] = Field(alias='dpv_door_not_accessible')
    ...
    dpv_footnotes: typing.List[DpvFootnote] = Field(alias='dpv_footnotes')
    ...
    ews_match: bool = Field(alias='ews_match')
    ...
    lacs_indicator: Literal["Y", "N", ""] = Field(alias='lacs_indicator')
    ...
    lacs_return_code: str = Field(alias='lacs_return_code')
    ...
    suite_return_code: Literal["A", "00", ""] = Field(alias='suite_return_code')
    class Config:
