...
from lob_python_sdk.model.template import Template as TemplateSchema
...
from lob_python_sdk.model.template_writable import TemplateWritable as TemplateWritableSchema

from lob_python_sdk.type.template_html import TemplateHtml
from lob_python_sdk.type.template import Template
...
from lob_python_sdk.type.template_writable import TemplateWritable
...
from lob_python_sdk.pydantic.template_writable import TemplateWritable as TemplateWritablePydantic
from lob_python_sdk.pydantic.template import Template as TemplatePydantic
from lob_python_sdk.pydantic.template_required_vars import TemplateRequiredVars as TemplateRequiredVarsPydantic

# body param
SchemaForRequestBodyApplicationJson = TemplateWritableSchema
SchemaForRequestBodyApplicationXWwwFormUrlencoded = TemplateWritableSchema
SchemaForRequestBodyMultipartFormData = TemplateWritableSchema


request_body_template_writable = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _atemplate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_template_writable.serialize(body, content_type)
...
class TemplateRaw(BaseApi):
    ...
    async def atemplate(
        ...
        **kwargs,
        ...
        args = self._template_mapped_args(
            html=html,
        ...
        return await self._atemplate_oapg(
            body=args.body,
            **kwargs,
        )
...
class Template(BaseApi):
    ...
    async def atemplate(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atemplate(
            html=html,
            description=description,
            metadata=metadata,
            engine=engine,
    ...
    def template(
        ...
        raw_response = self.raw.template(
            html=html,
            description=description,
            metadata=metadata,
            engine=engine,
