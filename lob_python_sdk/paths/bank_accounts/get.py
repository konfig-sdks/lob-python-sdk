...
from lob_python_sdk.model.bank_accounts_get_list_response import BankAccountsGetListResponse as BankAccountsGetListResponseSchema

from lob_python_sdk.type.bank_accounts_get_list_response import BankAccountsGetListResponse
...
from lob_python_sdk.pydantic.bank_accounts_get_list_response import BankAccountsGetListResponse as BankAccountsGetListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BankAccountsGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BankAccountsGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BankAccountsGetListResponsePydantic:
        ...
        if validate:
            return RootModel[BankAccountsGetListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BankAccountsGetListResponsePydantic, raw_response.body)
