...
class IntlVerifications(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def addresses() -> typing.Type['IntlVerificationsAddresses']:
                return IntlVerificationsAddresses
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["addresses"]) -> 'IntlVerificationsAddresses': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["addresses"]) -> 'IntlVerificationsAddresses': ...
