...
class TemplateVersionUpdatable(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "engine", "required_vars", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "engine", "required_vars", ], str]):
