...
class RequiredUploadUpdatable(TypedDict):
    pass

class OptionalUploadUpdatable(TypedDict, total=False):
...
class UploadUpdatable(RequiredUploadUpdatable, OptionalUploadUpdatable):
    pass
