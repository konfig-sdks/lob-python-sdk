...
from lob_python_sdk.model.addresses_list_response import AddressesListResponse as AddressesListResponseSchema
...
from lob_python_sdk.type.addresses_list_response import AddressesListResponse
from lob_python_sdk.type.date_filter import DateFilter
from lob_python_sdk.type.metadata import Metadata

from ...api_client import Dictionary
from lob_python_sdk.pydantic.addresses_list_response import AddressesListResponse as AddressesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AddressesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AddressesListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[AddressesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AddressesListResponsePydantic, raw_response.body)
