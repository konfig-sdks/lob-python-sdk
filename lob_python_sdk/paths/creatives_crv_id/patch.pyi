...
from lob_python_sdk.model.creative_base import CreativeBase as CreativeBaseSchema
...
from lob_python_sdk.model.crv_id import CrvId as CrvIdSchema
...
from lob_python_sdk.type.crv_id import CrvId
...
from lob_python_sdk.pydantic.creative_base import CreativeBase as CreativeBasePydantic
from lob_python_sdk.pydantic.crv_id import CrvId as CrvIdPydantic
...
# Path params
CrvIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'crv_id': typing.Union[CrvIdSchema, ],
    }
)
...
request_path_crv_id = api_client.PathParameter(
    name="crv_id",
...
# body param
SchemaForRequestBodyApplicationJson = CreativeBaseSchema
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CreativeBaseSchema
SchemaForRequestBodyMultipartFormData = CreativeBaseSchema


request_body_creative_base = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_mapped_args(
        ...
        args.body = _body
        if crv_id is not None:
            _path_params["crv_id"] = crv_id
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/creatives/{crv_id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_creative_base.serialize(body, content_type)
