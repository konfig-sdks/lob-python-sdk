...
from lob_python_sdk.type.identity_validation_recipient import IdentityValidationRecipient
...
class RequiredRecipientValidation(TypedDict):
    pass

class OptionalRecipientValidation(TypedDict, total=False):
    id: IdentityValidationId

    recipient: IdentityValidationRecipient
...
class RecipientValidation(RequiredRecipientValidation, OptionalRecipientValidation):
    pass
