    ...
    async def _asend_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/campaigns/{cmp_id}/send',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SendRaw(BaseApi):
    ...
    async def asend(
        ...
        **kwargs,
        ...
        args = self._send_mapped_args(
            cmp_id=cmp_id,
        )
        return await self._asend_oapg(
...
class Send(BaseApi):
    ...
    async def asend(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asend(
            cmp_id=cmp_id,
            **kwargs,
        )
        if validate:
