...
from lob_python_sdk.model.postcards_list_response import PostcardsListResponse as PostcardsListResponseSchema
...
from lob_python_sdk.type.postcards_list_response import PostcardsListResponse
...
from lob_python_sdk.pydantic.postcards_list_response import PostcardsListResponse as PostcardsListResponsePydantic
...
class SizeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PostcardSize']:
            return PostcardSize

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['PostcardSize'], typing.List['PostcardSize']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'SizeSchema':
        return super().__new__(
            cls,
    ...
    def __getitem__(self, i: int) -> 'PostcardSize':
        return super().__getitem__(i)
...
SchemaFor200ResponseBodyApplicationJson = PostcardsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PostcardsListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        size: typing.Optional[typing.List[PostcardSize]] = None,
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[PostcardsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PostcardsListResponsePydantic, raw_response.body)
