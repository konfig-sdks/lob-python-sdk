...
from lob_python_sdk.model.self_mailers_get_list_response import SelfMailersGetListResponse as SelfMailersGetListResponseSchema
...
from lob_python_sdk.type.self_mailers_get_list_response import SelfMailersGetListResponse
...
from lob_python_sdk.pydantic.self_mailers_get_list_response import SelfMailersGetListResponse as SelfMailersGetListResponsePydantic
...
class SizeSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['SelfMailerSize']:
            return SelfMailerSize

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['SelfMailerSize'], typing.List['SelfMailerSize']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'SizeSchema':
        return super().__new__(
            cls,
    ...
    def __getitem__(self, i: int) -> 'SelfMailerSize':
        return super().__getitem__(i)
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'size': typing.Union[SizeSchema, list, tuple, ],
...
SchemaFor200ResponseBodyApplicationJson = SelfMailersGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SelfMailersGetListResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_list_mapped_args(
        ...
        size: typing.Optional[typing.List[SelfMailerSize]] = None,
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SelfMailersGetListResponsePydantic:
        ...
        if validate:
            return RootModel[SelfMailersGetListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(SelfMailersGetListResponsePydantic, raw_response.body)
