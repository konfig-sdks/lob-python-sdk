...
from lob_python_sdk.model.template_deletion import TemplateDeletion as TemplateDeletionSchema
...
from lob_python_sdk.type.template_deletion import TemplateDeletion

from ...api_client import Dictionary
from lob_python_sdk.pydantic.error import Error as ErrorPydantic
from lob_python_sdk.pydantic.template_deletion import TemplateDeletion as TemplateDeletionPydantic
...
SchemaFor200ResponseBodyApplicationJson = TemplateDeletionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TemplateDeletion
...
class Delete(BaseApi):
    ...
    async def adelete(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TemplateDeletionPydantic:
        raw_response = await self.raw.adelete(
            tmpl_id=tmpl_id,
            **kwargs,
        )
        if validate:
            return TemplateDeletionPydantic(**raw_response.body)
        return api_client.construct_model_instance(TemplateDeletionPydantic, raw_response.body)
