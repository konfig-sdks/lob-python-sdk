...
class RequiredLobConfidenceScore(TypedDict):
...
class OptionalLobConfidenceScore(TypedDict, total=False):
    pass

class LobConfidenceScore(RequiredLobConfidenceScore, OptionalLobConfidenceScore):
    pass
