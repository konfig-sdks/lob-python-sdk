...
class RequiredTemplateVersionWritable(TypedDict):
    html: TemplateHtml

class OptionalTemplateVersionWritable(TypedDict, total=False):
...
class TemplateVersionWritable(RequiredTemplateVersionWritable, OptionalTemplateVersionWritable):
    pass
