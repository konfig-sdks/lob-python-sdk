...
class RequiredTemplateUpdate(TypedDict):
    pass

class OptionalTemplateUpdate(TypedDict, total=False):
    description: ResourceDescription

    published_version: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

class TemplateUpdate(RequiredTemplateUpdate, OptionalTemplateUpdate):
    pass
