...
from lob_python_sdk.model.templates_list_response import TemplatesListResponse as TemplatesListResponseSchema
...
from lob_python_sdk.type.templates_list_response import TemplatesListResponse
...
from lob_python_sdk.pydantic.templates_list_response import TemplatesListResponse as TemplatesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TemplatesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TemplatesListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[TemplatesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(TemplatesListResponsePydantic, raw_response.body)
