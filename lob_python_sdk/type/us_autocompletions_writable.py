...
class RequiredUsAutocompletionsWritable(TypedDict):
    # Only accepts numbers and street names in an alphanumeric format. 
    address_prefix: str

class OptionalUsAutocompletionsWritable(TypedDict, total=False):
...
class UsAutocompletionsWritable(RequiredUsAutocompletionsWritable, OptionalUsAutocompletionsWritable):
    pass
