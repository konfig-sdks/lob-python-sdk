...
from lob_python_sdk.pydantic.identity_validation_recipient import IdentityValidationRecipient
...
class RecipientValidation(BaseModel):
    ...
    recipient: typing.Optional[IdentityValidationRecipient] = Field(None, alias='recipient')
