...
from lob_python_sdk.model.checks_list_response import ChecksListResponse as ChecksListResponseSchema
...
from lob_python_sdk.type.checks_list_response import ChecksListResponse
...
from lob_python_sdk.pydantic.checks_list_response import ChecksListResponse as ChecksListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ChecksListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChecksListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ChecksListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ChecksListResponsePydantic, raw_response.body)
