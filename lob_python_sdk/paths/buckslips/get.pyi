...
from lob_python_sdk.model.buckslips_list_response import BuckslipsListResponse as BuckslipsListResponseSchema

from lob_python_sdk.type.error import Error
from lob_python_sdk.type.buckslips_list_response import BuckslipsListResponse

from ...api_client import Dictionary
from lob_python_sdk.pydantic.error import Error as ErrorPydantic
from lob_python_sdk.pydantic.buckslips_list_response import BuckslipsListResponse as BuckslipsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BuckslipsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BuckslipsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[BuckslipsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(BuckslipsListResponsePydantic, raw_response.body)
