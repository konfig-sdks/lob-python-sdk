...
from lob_python_sdk.model.campaign_delete_response import CampaignDeleteResponse as CampaignDeleteResponseSchema
from lob_python_sdk.model.error import Error as ErrorSchema

from lob_python_sdk.type.campaign_delete_response import CampaignDeleteResponse
...
from lob_python_sdk.pydantic.campaign_delete_response import CampaignDeleteResponse as CampaignDeleteResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CampaignDeleteResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CampaignDeleteResponse
...
class Delete(BaseApi):
    ...
    async def adelete(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CampaignDeleteResponsePydantic:
        raw_response = await self.raw.adelete(
            cmp_id=cmp_id,
            **kwargs,
        )
        if validate:
            return CampaignDeleteResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CampaignDeleteResponsePydantic, raw_response.body)
