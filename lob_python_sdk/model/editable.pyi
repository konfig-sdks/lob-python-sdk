...
class Editable(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "metadata", "mail_type", "merge_variables", "send_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "metadata", "mail_type", "merge_variables", "send_date", ], str]):
