...
from lob_python_sdk.model.self_mailer_size import SelfMailerSize as SelfMailerSizeSchema
...
from lob_python_sdk.model.self_mailer import SelfMailer as SelfMailerSchema
from lob_python_sdk.model.merge_variables import MergeVariables as MergeVariablesSchema
from lob_python_sdk.model.self_mailer_editable import SelfMailerEditable as SelfMailerEditableSchema
from lob_python_sdk.model.sfm_use_type import SfmUseType as SfmUseTypeSchema
...
from lob_python_sdk.type.self_mailer import SelfMailer
from lob_python_sdk.type.sfm_use_type import SfmUseType
from lob_python_sdk.type.self_mailer_editable import SelfMailerEditable
...
from lob_python_sdk.pydantic.self_mailer_size import SelfMailerSize as SelfMailerSizePydantic
...
from lob_python_sdk.pydantic.sfm_use_type import SfmUseType as SfmUseTypePydantic
...
from lob_python_sdk.pydantic.self_mailer_editable import SelfMailerEditable as SelfMailerEditablePydantic
from lob_python_sdk.pydantic.self_mailer import SelfMailer as SelfMailerPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SelfMailerEditableSchema
SchemaForRequestBodyApplicationXWwwFormUrlencoded = SelfMailerEditableSchema
SchemaForRequestBodyMultipartFormData = SelfMailerEditableSchema


request_body_self_mailer_editable = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SelfMailerSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_self_mailer_mapped_args(
        self,
        ...
        items: typing.Optional[SelfMailerSize] = None,
        ...
        use_type: typing.Optional[SfmUseType] = None,
    ...
    async def _acreate_new_self_mailer_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/self_mailers',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_self_mailer_editable.serialize(body, content_type)
    ...
    def _create_new_self_mailer_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class CreateNewSelfMailerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_self_mailer(
        self,
        body: SelfMailerEditable,
        description: typing.Optional[ResourceDescription] = None,
        metadata: typing.Optional[Metadata] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_self_mailer_mapped_args(
            body=body,
        ...
        return await self._acreate_new_self_mailer_oapg(
            body=args.body,
    ...
    def create_new_self_mailer(
        ...
        return self._create_new_self_mailer_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class CreateNewSelfMailer(BaseApi):
    ...
    async def acreate_new_self_mailer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_self_mailer(
            body=body,
            description=description,
            metadata=metadata,
            mail_type=mail_type,
        ...
        if validate:
            return RootModel[SelfMailerPydantic](raw_response.body).root
        return api_client.construct_model_instance(SelfMailerPydantic, raw_response.body)
    ...
    def create_new_self_mailer(
        ...
        raw_response = self.raw.create_new_self_mailer(
            body=body,
            description=description,
            metadata=metadata,
            mail_type=mail_type,
