...
from lob_python_sdk.model.uploads_list_response import UploadsListResponse as UploadsListResponseSchema

from lob_python_sdk.type.uploads_list_response import UploadsListResponse
from lob_python_sdk.type.cmp_id import CmpId

from ...api_client import Dictionary
from lob_python_sdk.pydantic.cmp_id import CmpId as CmpIdPydantic
from lob_python_sdk.pydantic.uploads_list_response import UploadsListResponse as UploadsListResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'campaignId': typing.Union[CampaignIdSchema, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = UploadsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UploadsListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        if campaign_id is not None:
            _query_params["campaignId"] = campaign_id
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UploadsListResponsePydantic:
        raw_response = await self.raw.alist(
            campaign_id=campaign_id,
            **kwargs,
        )
        if validate:
            return RootModel[UploadsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UploadsListResponsePydantic, raw_response.body)
