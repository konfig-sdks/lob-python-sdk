...
from lob_python_sdk.model.card_deletion import CardDeletion as CardDeletionSchema

from lob_python_sdk.type.error import Error
from lob_python_sdk.type.card_deletion import CardDeletion
...
from lob_python_sdk.pydantic.card_deletion import CardDeletion as CardDeletionPydantic
...
SchemaFor200ResponseBodyApplicationJson = CardDeletionSchema
...
class Delete(BaseApi):
    ...
    async def adelete(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CardDeletionPydantic:
        raw_response = await self.raw.adelete(
            card_id=card_id,
            **kwargs,
        )
        if validate:
            return CardDeletionPydantic(**raw_response.body)
        return api_client.construct_model_instance(CardDeletionPydantic, raw_response.body)
