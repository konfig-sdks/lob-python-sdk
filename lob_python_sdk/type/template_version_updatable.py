...
class RequiredTemplateVersionUpdatable(TypedDict):
    pass

class OptionalTemplateVersionUpdatable(TypedDict, total=False):
...
class TemplateVersionUpdatable(RequiredTemplateVersionUpdatable, OptionalTemplateVersionUpdatable):
    pass
